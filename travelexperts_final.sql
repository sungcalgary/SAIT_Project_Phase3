...
(1304, '2018-10-17 16:10:40', NULL, 2, 105, 'B', 5),
(1305, '2018-10-17 16:18:48', NULL, 8, 105, 'B', 6),
(1306, '2018-10-18 10:02:24', NULL, 2, 105, 'B', 5),
(1307, '2018-10-18 10:58:23', NULL, 3, 105, 'B', 6);
...
INSERT INTO `clases` (`ClassId`, `ClassName`, `ClassDesc`) VALUES
...
CREATE TABLE `packags` (
  ...
  `PkgImageFile` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `packags`
--

INSERT INTO `packags` (`PackageId`, `PkgName`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `PkgBasePrice`, `PkgAgencyCommission`, `PkgImageFile`) VALUES
(1, 'Caribbean New Year', '2017-12-25 00:00:00', '2017-01-04 00:00:00', 'Cruise the Caribbean & Celebrate the New Year.', '4800.0000', '400.0000', 'caribbean.jpg'),
(2, 'Polynesian Paradise', '2016-12-12 00:00:00', '2016-12-20 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000', 'polynesian.jpg'),
(3, 'Asian Expedition', '2016-05-14 00:00:00', '2016-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000', 'asian.jpg'),
(4, 'European Vacation', '2016-11-01 00:00:00', '2016-11-14 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000', 'european.jpg'),
(5, 'European Vacation', '2018-12-01 00:00:00', '2018-12-14 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000', 'croatia.jpg'),
(6, 'Asian Expedition', '2019-05-14 00:00:00', '2019-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000', 'asian.jpg'),
(10, 'Polynesian Paradise', '2018-11-12 00:00:00', '2018-11-20 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000', 'polynesian.jpg');
...
--
-- AUTO_INCREMENT for table `packags`
--
ALTER TABLE `packags`
...
--
ALTER TABLE `products_suppliers`
  MODIFY `ProductSupplierId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
...
ALTER TABLE `bookingdetails`
  ...
  ADD CONSTRAINT `bookingdetails_ibfk_3` FOREIGN KEY (`ClassId`) REFERENCES `clases` (`ClassId`),
...
ALTER TABLE `bookings`
  ...
  ADD CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`PackageId`) REFERENCES `packags` (`PackageId`),
...
ALTER TABLE `packages_products_suppliers`
  ...
  ADD CONSTRAINT `packages_products_suppliers_ibfk_2` FOREIGN KEY (`PackageId`) REFERENCES `packags` (`PackageId`);
